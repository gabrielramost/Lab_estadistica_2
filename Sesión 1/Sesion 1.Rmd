...
Los objetos pueden ser usados para guardar valores y pueden modificarse (mediante funciones) como por ejemplo sumar dos objetos o calcular la media. 
...
Por otro lado, los **data frame** almacenan datos en forma de tablas (filas / columnas), como estamos habituados en Excel. Un data frame está compuesto de vectores de distintos tipos.

Normalmente los data frame los creamos al cargar/leer una base de datos relacional, sin embargo podemos crear un data frame desde R para ver su estructura.
